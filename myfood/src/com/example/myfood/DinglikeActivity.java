...
public class DinglikeActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		listView1 = (ListView) findViewById(R.dinglike.listView1);
		threadstart();
	}
	...
	private Handler Handler1 = new Handler() {
		public void handleMessage(Message msg) {
			try {
				if (loaddata().size() > 0) {
					...
					adapter = new SimpleAdapter(DinglikeActivity.this,
							goodslist, R.layout.item_dinglike, new String[] {
									...
									R.item_dinglike.textView1,
									R.item_dinglike.textView2 });
					...
					Toast.makeText(DinglikeActivity.this, "没有喜欢的菜品记录哦！", 1)
							.show();
				}
				...
				e.printStackTrace();
				ProgressDialog1.dismiss();
				Toast.makeText(DinglikeActivity.this, "网络不给力，无法获得菜品介绍。", 1)
						.show();
				// neterror();//网络重试
			}
		}
