...
public class DiancaiActivity extends Activity {
	...
	public void bindgoods() {
		...
		Button1.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				myapplication1
						.setgoodsurl("/android/json_goods/list.aspx?channel_id=2&page=");
				page = 1;
				havedata = true;
				threadstart();
			}
				...
				mydialog.setAdapter(dqadapter,
						new DialogInterface.OnClickListener() {
							...
							public void onClick(DialogInterface dialog,
								...
								try {
									myapplication1
											.setgoodsurl("/android/json_goods/list.aspx?channel_id=2&category_id="
													+ dqlist.get(which)
															.get("id")
															.toString()
													+ "&page=");
		...
		Button5.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (dinglikeDBManager.havadata()) {
					...
					Toast.makeText(DiancaiActivity.this, "暂无喜欢的菜品", 1).show();
				}
			}
		});
	...
	private Handler handlerlike = new Handler() {
		...
		public void handleMessage(Message msg) {
			try {
				...
				myapplication1
						.setgoodsurl("/android/json_goods/list.aspx?channel_id=2&id="
		...
		try {
			...
			dqcategory = jsoncategory
					...
					myapplication1.getlocalhost()
							+ "/android/json_category/list.aspx?channel_id=2&call_index=cd&page="
							+ page);
		...
		public void handleMessage(Message msg) {
			try {
				...
				if (list1.size() > 0) {
					...
					ProgressDialog1.dismiss();
					Toast.makeText(DiancaiActivity.this, "暂时没有对应菜品介绍哦", 1)
							.show();
				}
	...
	public List<goods> loaddata(int page) {
		...
		try {
			goodss = jsongoods
					...
					myapplication1.getlocalhost()
							+ myapplication1.getgoodsurl() + page);
	...
	protected Dialog onCreateDialog(int id) {
		...
		RecognizerDialog recognizerDialog = new RecognizerDialog(
				DiancaiActivity.this, "appid=5132fe14");// 这里应该写从科大讯飞申请到的appid
